...
public class CamActivity extends AppCompatActivity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, notesList.get(0).getTitle(), Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.camVoice).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityCompat.requestPermissions
                        (CamActivity.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_RECORD_PERMISSION);
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==REQUEST_RECORD_PERMISSION){
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(CamActivity.this, "Voice Permission Denied!", Toast
                        .LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onResults(Bundle results) {
        ...
        for (String result : matches){
            for(Model carga : notesList){
                if(result.equals(carga.getTitle())){
                    rs=1;
                    break;
                }
            }
